...
/*
 * Override/adjust fontsize for chosen monitors.
 ...
 * attribute.
 */
static unsigned int blinktimeout = 600; /* match alacritty blink_interval */

/*
 * thickness of underline and bar cursors
 */
static unsigned int cursorthickness = 3; /* ~0.15 of cell width */
...
static const char *colorname[] = {
  ...
  "#cdd6f4", /* 256: default foreground */
  "#1e1e2e", /* 257: default background */
  "#f5e0dc", /* 258: cursor             */
  "#1e1e2e", /* 259: cursor text        */
};
...
static Shortcut shortcuts[] = {
  ...
  /* font size — match alacritty: Ctrl+Plus / Ctrl+Minus / Ctrl+0 */
...
/*
 * boxdraw — render box-drawing characters (U+2500–U+259F) and braille
 * (U+2800–U+28FF) natively instead of using font glyphs.
 * All disabled by default; enable as desired.
 */
int boxdraw = 0;
int boxdraw_bold = 0;
